...
public boolean isSearchorderDisplayed() {
	...
	public void searchByProductName(String productNameToSearch) {
		
		    WebElement searchInput = driver.findElement(By.xpath("//*[@id=\"orderAutoComplete\"]")); // Replace "searchInput" with the actual ID of the search input field
		    ...
		    // Press Enter key to perform the search (optional, depending on how the search is triggered)
